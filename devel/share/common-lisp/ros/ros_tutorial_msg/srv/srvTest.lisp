...
(cl:in-package ros_tutorial_msg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <srvTest-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srvTest-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_tutorial_msg-srv:<srvTest-request> is deprecated: use ros_tutorial_msg-srv:srvTest-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <srvTest-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tutorial_msg-srv:a-val is deprecated.  Use ros_tutorial_msg-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <srvTest-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tutorial_msg-srv:b-val is deprecated.  Use ros_tutorial_msg-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srvTest-request>)))
  ...
  "ros_tutorial_msg/srvTestRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvTest-request)))
  "Returns string type for a service object of type 'srvTest-request"
  "ros_tutorial_msg/srvTestRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <srvTest-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srvTest-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_tutorial_msg-srv:<srvTest-response> is deprecated: use ros_tutorial_msg-srv:srvTest-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <srvTest-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tutorial_msg-srv:result-val is deprecated.  Use ros_tutorial_msg-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srvTest-response>)))
  ...
  "ros_tutorial_msg/srvTestResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvTest-response)))
  "Returns string type for a service object of type 'srvTest-response"
  "ros_tutorial_msg/srvTestResponse")
